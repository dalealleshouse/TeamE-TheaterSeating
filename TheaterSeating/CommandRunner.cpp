...
namespace theater
{
	...
	CommandRunner::CommandRunner(const TheaterConfiguration configuration, bool& end_program, ConfirmFunc confirm)
		: _theater_services{configuration, confirm}, _end_program{end_program}
